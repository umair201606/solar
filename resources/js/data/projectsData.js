...
export const projects = [
  {
    ...
    desc: "Large-scale solar installation for one of Pakistan's leading steel mills, powering heavy industrial operations with 5 MWp of clean energy. A landmark project in Pakistan's industrial solar sector.",
    completionDate: "Completed",
    tags: [
      { icon: Zap, text: "5 MWp" },
      { icon: Building2, text: "Heavy Industry" },
    ...
    objectivesList: ["Megawatt solar array design and installation", "Grid-tied integration for seamless power supply", "Load balancing for heavy machinery operations"],
    ...
    testimonial: {
      quote: "Solarkon delivered a massive solar solution that powers our entire steel operation. The savings and reliability have exceeded our expectations.",
      name: "Bashir Sons Operations Director",
      role: "Steel Industry, Kala Shah Kaku",
      img: siteImages.clients.industrial,
    },
    gallery: [
  ...
  },
  {
    ...
    loc: "Multiple Branches, Pakistan",
    desc: "Multi-branch solar installation for one of Pakistan's largest bakery chains. 3.5 MWp distributed across multiple locations, ensuring consistent power for production facilities.",
    completionDate: "Completed",
    tags: [
      { icon: Zap, text: "3.5 MWp" },
      { icon: Building2, text: "Food Industry" },
    ...
    objectivesList: ["Distributed solar deployment across branches", "Cold storage power backup integration", "Energy monitoring and optimization"],
    ...
    testimonial: {
      quote: "Solarkon's multi-site installation keeps our bakeries running smoothly across all locations. A game-changer for our operations.",
      name: "Gourmet Facilities Manager",
      role: "Food Production, Pakistan",
      img: siteImages.clients.corporate,
    },
    gallery: [
  ...
  },
  {
    ...
    loc: "Daska, Sialkot",
    desc: "Solar power solution for a major food processing facility in Daska. 1.2 MWp system designed to meet the high energy demands of food processing, packaging, and cold storage operations.",
    completionDate: "Completed",
    tags: [
      { icon: Zap, text: "1.2 MWp" },
      { icon: Building2, text: "Food Processing" },
      { icon: Sun, text: "Grid-Tied Solar PV" },
    ],
    ...
    objectivesList: ["High-capacity solar array for processing plant", "Cold storage power reliability", "Grid-tied with net metering"],
    ...
    testimonial: {
      quote: "The solar system from Solarkon has transformed our processing facility's energy profile. Reliable power and significant savings.",
      name: "Hajvery Foods Plant Manager",
      role: "Food Industry, Daska",
      img: siteImages.clients.industrial,
    },
    gallery: [
  ...
  },
  {
    ...
    loc: "Pakistan",
    desc: "Solar power solution for a flour milling facility, ensuring reliable energy for grinding, packaging, and storage operations.",
    ...
    objectivesList: ["Commercial solar array design", "Grid-tied integration", "Load balancing for milling machinery"],
    ...
    testimonial: {
      quote: "Solarkon's solar solution keeps our flour mill running efficiently. Reliable power and great savings.",
      name: "Azaan Flour Mill Management",
      role: "Food Processing, Pakistan",
      img: siteImages.clients.industrial,
    },
    gallery: [],
  },
  {
    ...
    objectivesList: ["10 MWp solar array installation", "Integration with existing system", "Enhanced load balancing"],
    ...
    testimonial: {
      quote: "The Phase 2 expansion with Solarkon will double our solar capacity, further reducing our operational costs.",
      name: "Bashir Sons Operations Director",
      role: "Steel Industry, Kala Shah Kaku",
      img: siteImages.clients.industrial,
    },
