...
function LogoItem({ logo }) {
  return (
    ...
    >
      <img src={logo.src} alt={logo.alt} loading="lazy" className="h-12 w-auto object-contain" />
    </div>
  );
}
...
export default function PartnerLogos() {
  ...
  return (
    <div className="mt-24 text-center overflow-hidden">
      <p
        ref={ref}
        className={`font-bold text-dark-bg mb-8 px-6 ${visible ? 'slide-from-left' : 'slide-from-left-init'}`}
      >
